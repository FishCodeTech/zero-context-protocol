...
export const benchmarksCopy: Record<Locale, BenchmarksCopy> = {
  en: {
    ...
    summary:
      "This page renders generated benchmark artifacts. The benchmark runner and raw evidence live in the Python SDK repository.",
    description:
      "This page consumes generated benchmark artifacts from the Python SDK repository. The benchmark logic itself belongs to `zero-context-protocol-python`, not the docs site.",
    missingTitle: "No benchmark report found",
    missingBody:
      "Expected a generated report at `benchmark_reports/zcp_mcp_tool_call_benchmark.json`. Run the real SDK benchmark from the Python repository before building this page.",
    snapshotTitle: "Latest snapshot",
    modelLabel: "Model",
    repeatsLabel: "Repeats",
    summaryTitle: "Summary",
    casesTitle: "Case breakdown",
    summaryHeaders: ["Protocol", "Runs", "Answer Accuracy", "Tool Compliance", "Avg Prompt", "Avg Completion", "Avg Total"],
    caseHeaders: ["Case", "ZCP Avg Total", "MCP Avg Total", "MCP / ZCP", "Token Delta"],
  },
  zh: {
    navLabel: "基准测试",
    nav: [
      ...
      { href: "#summary", label: "汇总" },
      { href: "#cases", label: "案例" },
    ],
    title: "基准报告",
    summary: "这个页面负责渲染已生成的 benchmark 产物。benchmark runner 和原始证据位于 Python SDK 仓库。",
    description:
      "这个页面消费来自 Python SDK 仓库的 benchmark 结果文件。benchmark 逻辑本身属于 `zero-context-protocol-python`，而不是 docs 站点。",
    missingTitle: "未找到基准报告",
    missingBody:
      "预期在 `benchmark_reports/zcp_mcp_tool_call_benchmark.json` 找到生成好的报告。请先在 Python 仓库里运行真实 benchmark，再构建这个页面。",
    snapshotTitle: "最新快照",
    modelLabel: "模型",
    repeatsLabel: "重复次数",
    summaryTitle: "汇总",
    casesTitle: "案例拆解",
    summaryHeaders: ["协议", "运行次数", "回答准确率", "工具合规率", "平均 Prompt", "平均 Completion", "平均总量"],
    caseHeaders: ["案例", "ZCP 平均总量", "MCP 平均总量", "MCP / ZCP", "Token 差值"],
  },
};
